...
import com.YaoYaxin.rest.webservices.restfulwebservices.User.UserNotFoundException;
...
extends ResponseEntityExceptionHandler{
	...
	(Exception ex, WebRequest request) throws Exception {
		ExceptionResponce exceptionResponce =
				new ExceptionResponce(new Date(), ex.getMessage(),
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		ExceptionResponce exceptionResponce =
				new ExceptionResponce(new Date(), "Validation Failed",
